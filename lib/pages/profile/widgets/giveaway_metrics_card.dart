...
class GiveawayMetricsCard extends StatelessWidget {
  ThemeData theme;
  GiveAway giveAway;
  GiveawayMetricsCard({super.key, required this.theme, required this.giveAway});
            ...
            child: Row(
              children: [
                Row(
                  children: [
                    ShowImage(
                      image: giveAway.user?.profilePhoto ?? '',
                      height: 30,
                      width: 30,
                    ),
                    SizedBox(
