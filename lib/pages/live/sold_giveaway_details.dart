...
class SoldGiveawayDetails extends StatelessWidget {
  Order order;
  SoldGiveawayDetails({super.key, required this.order});
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Stack(
                fit: StackFit.expand,
                children: [
                  if (giveAway?.images?.isEmpty == true)
                    Image.asset(
                      "assets/images/image_placeholder.jpg",
                      fit: BoxFit.cover,
                    ),
                  if (giveAway?.images?.isNotEmpty == true)
                    CachedNetworkImage(
                      imageUrl: giveAway!.images!.first,
                      fit: BoxFit.cover,
                    ),
                  Container(
          ...
          Column(
            ...
            children: [
              Padding(
                ...
                child: Text(order.giveaway?.description ?? ""),
              ),
              if (order.giveaway?.category != null)
                Container(
                  decoration: BoxDecoration(
                    color: theme.colorScheme.onSecondaryContainer,
                    borderRadius: BorderRadius.circular(8),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(order.giveaway?.category?.name ?? "",
                          style: theme.textTheme.bodyLarge),
                    ],
                  ),
                ),
