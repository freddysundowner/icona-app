...
class ProductSwipeCard extends StatelessWidget {
  ...
  ProductSwipeCard({super.key, required this.list}) {}
  @override
    ...
    return Scaffold(
      body: PageView.builder(
        ...
        controller: PageController(
          initialPage: productController.currentProductIndexSwiper.value,
        ),
...
class _ProductCardState extends State<ProductCard> {
  ...
  void initState() {
    super.initState();
    _getShippingEstimates();
  }

  _getShippingEstimates() async {
    await shippingController.getShippingEstimate(data: {
      'weight': widget.product.shipping_profile?.weight,
      "owner": widget.product.ownerId?.id,
                ...
                child: Row(
                  ...
                  children: [
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        if (widget.product.ownerId?.profilePhoto != '' &&
                            widget.product.ownerId?.profilePhoto != null)
                          CircleAvatar(
                        ...
                        if (widget.product.ownerId?.profilePhoto == '' ||
                          ...
                          CircleAvatar(
                            radius: 18.sp,
                            child: Text(
                              widget.product.ownerId?.firstName
                                      .toString()
                                      .substring(0, 1)
                                      .toUpperCase() ??
                                  "S",
            ...
            child: Column(
              ...
              children: [
                InkWell(
                  ...
                  onTap: () {
                    productController.currentProduct.value = widget.product;
                  ...
                  Row(
                    children: [
                      ...
                      if (widget.product.listing_type == "buy_now")
                        Expanded(
                          child: ElevatedButton(
                            onPressed: shippingController
                                    .loadingShippingEstimate.isTrue
                                ? null
                                : () {
